...
def _classify_site_check_in(
    ...
    if policy:
        ...
        snapshot = {"authority": "implicit_flexible_during_migration"}
    geofence_reason = {
...
def _write_arrival_policy(
    *,
    ...
    return revision_id, site_id, job_id
...
def admin_put_site_arrival_policy(
    ...
    revision_id, resolved_site_id, _ = _write_arrival_policy(
        scope_type="site",
        target_id=site_id,
        payload=payload,
        admin=admin,
...
def admin_retire_site_arrival_policy(
    ...
    revision_id, resolved_site_id, _ = _retire_arrival_policy(
        scope_type="site",
        target_id=site_id,
        payload=payload,
        admin=admin,
...
def admin_put_appointment_arrival_policy(
    ...
    revision_id, site_id, resolved_job_id = _write_arrival_policy(
        scope_type="appointment",
        target_id=job_id,
        payload=payload,
        admin=admin,
...
def admin_retire_appointment_arrival_policy(
    ...
    revision_id, site_id, resolved_job_id = _retire_arrival_policy(
        scope_type="appointment",
        target_id=job_id,
        payload=payload,
        admin=admin,
