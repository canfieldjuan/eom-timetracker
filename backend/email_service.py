...
class EmailService:
    ...
    def _create_monthly_report_email(
        self, month_name: str, year: int, summary_data: Dict[str, Any] = None
    ) -> str:
        ...
        company = self.company_name.strip() or "Company"
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hello,</p>
                    <p>Please find attached the monthly hours report for <strong>{company}</strong> for {month_name} {year}.</p>

                    <div class="attachment-note">
                        <strong>Attachment:</strong> Monthly Hours Report PDF is attached to this email.
                    </div>
                    ...
                    <div class="summary-box">
                        ...
                        <div class="summary-item">
                            <span class="summary-label">Most Active Employee:</span>
                    ...
                    <div class="financial-box">
                        ...
                        <p><strong>Total Revenue:</strong> {_fmt_currency(total_revenue)}</p>
                        <p><strong>Net Profit:</strong> {_fmt_currency(net_profit)}</p>
                    </div>
                    ''' if total_revenue is not None or net_profit is not None else '')}

                    <p>If you have any questions about this report, please contact your system administrator.</p>
                </div>

                <div class="footer">
                    <p>This is an automated report generated on {datetime.now().strftime("%B %d, %Y at %I:%M %p")}</p>
    ...
    def test_email_configuration(self) -> bool:
        ...
        try:
            ...
            # The API may accept the request and send a test email. This is used as a quick credential check.
            test_data = {
                "from": self.from_email,
                "to": [self.from_email],
                "subject": "Test",
