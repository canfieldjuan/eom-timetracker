...
class EmailService:
                ...
                <div class="content">
                    ...
                    <div class="summary-box">
                        ...
                        <div class="summary-item">
                            ...
                            <span class="summary-value">{summary_data.get("total_employees", "N/A")}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Total Hours Worked:</span>
                            <span class="summary-value">{summary_data.get("total_hours", "N/A"):.1f} hours</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Average Hours per Employee:</span>
                            <span class="summary-value">{summary_data.get("avg_hours", "N/A"):.1f} hours</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Overtime Hours:</span>
                            <span class="summary-value">{summary_data.get("overtime_hours", "N/A"):.1f} hours</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Top Performer:</span>
                            <span class="summary-value">{summary_data.get("top_employee", "N/A")}</span>
                        </div>
                    </div>
                    '''}
    ...
    def test_email_configuration(self) -> bool:
        """Validate required email configuration without sending a probe email."""
        api_key = str(self.resend_api_key or "").strip()
        ...
        if api_key.lower() in {"your_resend_api_key_here", "changeme", "test"}:
        ...
        if "@" not in from_email or any(
            placeholder in from_email_lower
            for placeholder in ("yourcompany", "example.com")
        ):
            print("from_email configuration appears to be a placeholder")
            return False

        print("Email configuration appears complete; skipped live send preflight")
        return True
